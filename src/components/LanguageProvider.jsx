...
export default function LanguageProvider({ children }) {
  ...
  const translations = {
    en: {
      ...
      beliefAllahText: "Belief in the existence of Allah Almighty, that He is One without partner, and that He is the Creator of all things.",
      beliefAngels: "Belief in Angels",
      beliefAngelsText: "Belief in the existence of angels, luminous creatures who never disobey Allah in what He commands them and do as they are commanded.",
      beliefDivineBooks: "Belief in the Divine Books",
      beliefDivineBooksText: "Belief that Allah revealed books to the prophets to guide humanity, such as the Holy Quran, the Torah, the Gospel, and the Psalms (for the last three, we mean the Real ones)",
      beliefMessengers: "Belief in the Messengers",
      beliefMessengersText: "Belief that Allah sent messengers and prophets to mankind to guide them (Noah, Abraham, Jesus, Moses...), the last of whom was Muhammad, peace and blessings be upon him.",
      beliefLastday: "Belief in the Last Days",
      beliefLastDayText: "Belief in the Day of Judgment, the day on which Allah will resurrect mankind for judgment and recompense.",
      beliefPredestination: "Belief in Predestination",
      beliefPredestinationText: "Belief that Allah has predestined everything, both good and evil, and that His eternal knowledge is His.",
      ...
      more_miracles_second_text: "It refers to scientific facts mentioned in the Qur’an that were proven by modern science centuries later, such as reference to the creation of the universe, the stages of fetal development, and many more.",
      more_miracles_third_title: "Unseen miracles",
      more_miracles_third_text: "Relates to news of the unseen, such as predictions of Muslim victories, future events, and more.",
      ...
      more_miracles_qna_first_text: "A brief and powerful explanation of what the Qur’an is:The literal word of Allah revealed to Prophet Muhammad ﷺ.A guide for all of humanity — not just Muslims.A book of purpose, law, wisdom, ethics, and spiritual healing.",
      more_miracles_qna_second_title: "Why Do Muslims Follow the Prophet Muhammad ﷺ?",
      more_miracles_qna_second_text: "He did not author the Qur’an.He lived the Qur’an — “his character was the Qur’an.”He is the final messenger in a long line of prophets (Noah, Jesus, Moses, Abraham, etc.), to know decent ethics, details of worship and guidance through Hadith.",
      more_miracles_qna_third_title: "How the Qur’an Changed the World",
      more_miracles_qna_third_text: "The transformation of Arabia in 23 years:From tribal warfare to unified civilization.From oppression of women to their dignity and rights, and so much else.",
      more_miracles_qna_fourth_title: "Is Islam a religion of violence?",
      more_miracles_qna_fourth_text: "Islam keeps justice, violence is used against unjust.",
      more_miracles_qna_fifth_title: "Does Islam oppress women?",
      more_miracles_qna_fifth_text: "No, as said, Islam keeps the right of everyone including women, in fact women thrived starting from the islamic era (the first days of Islam).",
